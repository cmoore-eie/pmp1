...
/**
 * REST controller for managing {@link pl.eie.pmp.domain.Contract}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Contract> partialUpdateContract(
        ...
        Optional<Contract> result = contractRepository
            ...
            .map(existingContract -> {
                if (contract.getAncestorItemIdentifier() != null) {
                    existingContract.setAncestorItemIdentifier(contract.getAncestorItemIdentifier());
                }
                if (contract.getCode() != null) {
                    existingContract.setCode(contract.getCode());
                }
                if (contract.getItemIdentifier() != null) {
                    existingContract.setItemIdentifier(contract.getItemIdentifier());
                }
                if (contract.getItemStatus() != null) {
                    existingContract.setItemStatus(contract.getItemStatus());
                }
                if (contract.getLocked() != null) {
                    existingContract.setLocked(contract.getLocked());
                }
                if (contract.getName() != null) {
                    existingContract.setName(contract.getName());
                }
                if (contract.getProductCode() != null) {
                    existingContract.setProductCode(contract.getProductCode());
                }
                if (contract.getVersionNumber() != null) {
                    existingContract.setVersionNumber(contract.getVersionNumber());
                }
