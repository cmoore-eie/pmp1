...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-seasoning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTSEASONING_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTSEASONING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTSEASONING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTSEASONING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTSEASONING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTSEASONING actions', async () => {
      const expectedActions = [
        {
