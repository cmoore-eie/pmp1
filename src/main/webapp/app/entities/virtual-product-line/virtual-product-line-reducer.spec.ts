...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTLINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTLINE actions', async () => {
      const expectedActions = [
        {
