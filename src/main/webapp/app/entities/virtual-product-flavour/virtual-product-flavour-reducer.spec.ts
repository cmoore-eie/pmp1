...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-flavour.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTFLAVOUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTFLAVOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTFLAVOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTFLAVOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTFLAVOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTFLAVOUR actions', async () => {
      const expectedActions = [
        {
