...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scheme.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEME_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEME actions', async () => {
      const expectedActions = [
        {
