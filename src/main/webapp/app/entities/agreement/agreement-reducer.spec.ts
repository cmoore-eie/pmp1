...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './agreement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGREEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGREEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGREEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGREEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGREEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGREEMENT actions', async () => {
      const expectedActions = [
        {
