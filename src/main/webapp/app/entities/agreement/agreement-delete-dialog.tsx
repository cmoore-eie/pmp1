...
import { getEntity, deleteEntity } from './agreement.reducer';

export const AgreementDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pmp1App.agreement.delete.question">Are you sure you want to delete this Agreement?</ModalBody>
      <ModalFooter>
