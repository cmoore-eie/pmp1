...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTVERSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTVERSION actions', async () => {
      const expectedActions = [
        {
