...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTCATEGORY actions', async () => {
      const expectedActions = [
        {
