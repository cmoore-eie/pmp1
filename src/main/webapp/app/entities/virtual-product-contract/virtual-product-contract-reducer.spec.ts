...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-contract.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTCONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTCONTRACT actions', async () => {
      const expectedActions = [
        {
