...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './virtual-product-organization.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTORGANIZATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIRTUALPRODUCTORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIRTUALPRODUCTORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIRTUALPRODUCTORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIRTUALPRODUCTORGANIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIRTUALPRODUCTORGANIZATION actions', async () => {
      const expectedActions = [
        {
