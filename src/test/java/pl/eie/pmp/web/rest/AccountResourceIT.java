...
import static pl.eie.pmp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import pl.eie.pmp.config.Constants;
import pl.eie.pmp.domain.PersistentToken;
import pl.eie.pmp.domain.User;
import pl.eie.pmp.repository.AuthorityRepository;
import pl.eie.pmp.repository.PersistentTokenRepository;
import pl.eie.pmp.repository.UserRepository;
import pl.eie.pmp.security.AuthoritiesConstants;
import pl.eie.pmp.service.UserService;
import pl.eie.pmp.service.dto.AdminUserDTO;
import pl.eie.pmp.service.dto.PasswordChangeDTO;
import pl.eie.pmp.service.dto.UserDTO;
import pl.eie.pmp.web.rest.vm.KeyAndPasswordVM;
import pl.eie.pmp.web.rest.vm.ManagedUserVM;
